...
X is the first publication destination and the master editorial version. Medium and
LinkedIn adaptations come only after the X Article and launch package are approved.
...
- Set the audience to public. This article is a brand and methodology introduction, not
  subscriber-only content.
- Confirm the article has one purpose: explain why MalliScore distinguishes how a start
  was built.
- Confirm the first 150 words contain the Imanaga-Wacha tension and founder promise.
...
- Confirm most paragraphs remain one to three sentences on mobile.
- Confirm each claim is followed by its evidence or example.
- Confirm there are no em dashes, repeated examples, or generic AI transitions.
- Preview on mobile before publishing.
- Do not publish the launch post until the Article URL exists.
- If a correction is needed after launch, prepare it first because entering edit mode
  unpublishes the Article until it is republished.
...
article, not to summarize every finding.
